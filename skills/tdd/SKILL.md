...
**Git Branch** Never start TDD on main/master branch without explicit user consent. Create a new branch using `git switch -c`. do not name the branch per issues if issues has parent prd or spec.
